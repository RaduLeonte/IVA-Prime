...
const codonTablesDict = {
    "Escherichia coli": {
        ...
        D: {0.63: 'GAT', 0.37: 'GAC'},
        E: {0.68: 'GAA', 0.32: 'GAG'},
        S: {0.25: 'AGC', 0.17: 'TCT', 0.16: 'AGT', 0.15: 'TCC', 0.14: 'TCA', 0.14100000000000001: 'TCG'},
        C: {0.54: 'TGC', 0.46: 'TGT'},
        W: {1.0: 'TGG'},
        P: {0.49: 'CCG', 0.2: 'CCA', 0.18: 'CCT', 0.13: 'CCC'},
        R: {0.36: 'CGT', 0.361: 'CGC', 0.11: 'CGG', 0.07: 'CGA', 0.07100000000000001: 'AGA', 0.04: 'AGG'},
    ...
    "Human": {
        F: {0.55: 'TTC', 0.45: 'TTT'},
        L: {0.41: 'CTG', 0.2: 'CTC', 0.13: 'TTG', 0.131: 'CTT', 0.07: 'TTA', 0.07100000000000001: 'CTA'},
        Y: {0.57: 'TAC', 0.43: 'TAT'},
        ...
        D: {0.54: 'GAC', 0.46: 'GAT'},
        E: {0.58: 'GAG', 0.42: 'GAA'},
        S: {0.24: 'AGC', 0.22: 'TCC', 0.18: 'TCT', 0.15: 'TCA', 0.151: 'AGT', 0.06: 'TCG'},
        C: {0.55: 'TGC', 0.45: 'TGT'},
        W: {1.0: 'TGG'},
        P: {0.33: 'CCC', 0.28: 'CCT', 0.27: 'CCA', 0.11: 'CCG'},
        R: {0.21: 'CGG', 0.2: 'AGA', 0.201: 'AGG', 0.19: 'CGC', 0.11: 'CGA', 0.08: 'CGT'},
        T: {0.36: 'ACC', 0.28: 'ACA', 0.24: 'ACT', 0.12: 'ACG'},
        A: {0.4: 'GCC', 0.26: 'GCT', 0.23: 'GCA', 0.11: 'GCG'},
        G: {0.34: 'GGC', 0.25: 'GGA', 0.251: 'GGG', 0.16: 'GGT'},
    },
    "Arabidopsis thaliana": {
        F: {0.51: 'TTT', 0.49: 'TTC'},
        L: {0.26: 'CTT', 0.22: 'TTG', 0.17: 'CTC', 0.13: 'TTA', 0.11: 'CTA', 0.111: 'CTG'},
        Y: {0.52: 'TAT', 0.48: 'TAC'},
        ...
        D: {0.68: 'GAT', 0.32: 'GAC'},
        E: {0.52: 'GAA', 0.49: 'GAG'},
        S: {0.28: 'TCT', 0.2: 'TCA', 0.16: 'AGT', 0.13: 'TCC', 0.131: 'AGC', 0.1: 'TCG'},
        C: {0.59: 'TGT', 0.41: 'TGC'},
        W: {1.0: 'TGG'},
    ...
    "C.elegans": {
        ...
        D: {0.68: 'GAT', 0.33: 'GAC'},
        E: {0.62: 'GAA', 0.38: 'GAG'},
        S: {0.25: 'TCA', 0.21: 'TCT', 0.15: 'TCG', 0.151: 'AGT', 0.13: 'TCC', 0.1: 'AGC'},
        C: {0.55: 'TGT', 0.45: 'TGC'},
        W: {1.0: 'TGG'},
    ...
    "Cricetulus griseus (CHO)": {
        ...
        D: {0.53: 'GAC', 0.47: 'GAT'},
        E: {0.59: 'GAG', 0.41: 'GAA'},
        S: {0.22: 'TCT', 0.221: 'AGC', 0.15: 'AGT', 0.14: 'TCA', 0.05: 'TCG'},
        C: {0.53: 'TGC', 0.47: 'TGT'},
        W: {1.0: 'TGG'},
        P: {0.32: 'CCC', 0.31: 'CCT', 0.29: 'CCA', 0.08: 'CCG'},
        R: {0.19: 'CGG', 0.191: 'AGG', 0.18: 'CGC', 0.14: 'CGA', 0.11: 'CGT'},
    ...
    "Drosophila melanogaster": {
        ...
        R: {0.33: 'CGC', 0.16: 'CGT', 0.15: 'CGA', 0.151: 'CGG', 0.11: 'AGG', 0.09: 'AGA'},
        T: {0.38: 'ACC', 0.26: 'ACG', 0.19: 'ACA', 0.17: 'ACT'},
        A: {0.45: 'GCC', 0.19: 'GCT', 0.191: 'GCG', 0.17: 'GCA'},
    ...
    "Insect": {
        ...
        D: {0.63: 'GAC', 0.37: 'GAT'},
        E: {0.59: 'GAG', 0.41: 'GAA'},
        S: {0.24: 'TCC', 0.19: 'TCT', 0.17: 'AGC', 0.16: 'TCA', 0.12: 'TCG', 0.121: 'AGT'},
        C: {0.65: 'TGC', 0.35: 'TGT'},
        W: {1.0: 'TGG'},
    ...
    "Mouse": {
        F: {0.57: 'TTC', 0.43: 'TTT'},
        L: {0.39: 'CTG', 0.2: 'CTC', 0.13: 'TTG', 0.131: 'CTT', 0.08: 'CTA', 0.06: 'TTA'},
        Y: {0.58: 'TAC', 0.43: 'TAT'},
    ...
    "Nicotiana tabacum (Tabacco)": {
        F: {0.58: 'TTT', 0.42: 'TTC'},
        L: {0.26: 'CTT', 0.24: 'TTG', 0.14: 'TTA', 0.14100000000000001: 'CTC', 0.12: 'CTG', 0.1: 'CTA'},
        Y: {0.57: 'TAT', 0.43: 'TAC'},
        X: {0.41: 'TAA', 0.411: 'TGA', 0.19: 'TAG'},
        H: {0.61: 'CAT', 0.39: 'CAC'},
        Q: {0.58: 'CAA', 0.42: 'CAG'},
        I: {0.5: 'ATT', 0.25: 'ATC', 0.251: 'ATA'},
        M: {1.0: 'ATG'},
        N: {0.6: 'AAT', 0.4: 'AAC'},
        K: {0.51: 'AAG', 0.49: 'AAA'},
        V: {0.41: 'GTT', 0.25: 'GTG', 0.17: 'GTC', 0.171: 'GTA'},
        D: {0.68: 'GAT', 0.32: 'GAC'},
        E: {0.55: 'GAA', 0.45: 'GAG'},
        ...
        R: {0.32: 'AGA', 0.26: 'AGG', 0.15: 'CGT', 0.11: 'CGA', 0.08: 'CGC', 0.081: 'CGG'},
        T: {0.39: 'ACT', 0.33: 'ACA', 0.19: 'ACC', 0.09: 'ACG'},
        A: {0.44: 'GCT', 0.31: 'GCA', 0.17: 'GCC', 0.08: 'GCG'},
        G: {0.34: 'GGT', 0.341: 'GGA', 0.17: 'GGC', 0.15: 'GGG'},
    },
    "Pichia pastoris": {
        F: {0.56: 'TTT', 0.44: 'TTC'},
        ...
        D: {0.59: 'GAT', 0.41: 'GAC'},
        E: {0.58: 'GAA', 0.42: 'GAG'},
        S: {0.29: 'TCT', 0.2: 'TCC', 0.19: 'TCA', 0.15: 'AGT', 0.09: 'TCG', 0.091: 'AGC'},
        C: {0.65: 'TGT', 0.35: 'TGC'},
        W: {1.0: 'TGG'},
        P: {0.4: 'CCA', 0.35: 'CCT', 0.16: 'CCC', 0.1: 'CCG'},
        R: {0.47: 'AGA', 0.16: 'CGT', 0.161: 'AGG', 0.11: 'CGA', 0.05: 'CGC', 0.051000000000000004: 'CGG'},
    ...
    "Pig": {
        F: {0.62: 'TTC', 0.38: 'TTT'},
        L: {0.4: 'CTG', 0.21: 'CTC', 0.13: 'CTA', 0.1: 'TTG', 0.101: 'CTT', 0.06: 'TTA'},
        Y: {0.65: 'TAC', 0.35: 'TAT'},
        ...
        D: {0.62: 'GAC', 0.38: 'GAT'},
        E: {0.62: 'GAG', 0.38: 'GAA'},
        S: {0.26: 'TCC', 0.261: 'AGC', 0.15: 'TCT', 0.151: 'TCA', 0.12: 'AGT', 0.06: 'TCG'},
        C: {0.61: 'TGC', 0.39: 'TGT'},
        W: {1.0: 'TGG'},
        P: {0.35: 'CCC', 0.27: 'CCA', 0.24: 'CCT', 0.13: 'CCG'},
        R: {0.22: 'CGC', 0.2: 'CGG', 0.201: 'AGG', 0.19: 'AGA', 0.12: 'CGA', 0.07: 'CGT'},
    ...
    "Rat": {
        F: {0.59: 'TTC', 0.41: 'TTT'},
        L: {0.42: 'CTG', 0.21: 'CTC', 0.12: 'TTG', 0.121: 'CTT', 0.07: 'CTA', 0.06: 'TTA'},
        Y: {0.6: 'TAC', 0.4: 'TAT'},
        ...
        R: {0.21: 'AGG', 0.2: 'CGG', 0.201: 'AGA', 0.18: 'CGC', 0.12: 'CGA', 0.09: 'CGT'},
    ...
    "Saccharomyces cerevisiae (gbpln)": {
        ...
        N: {0.59: 'AAT', 0.41: 'AAC'},
        K: {0.58: 'AAA', 0.42: 'AAG'},
        V: {0.39: 'GTT', 0.21: 'GTC', 0.211: 'GTA', 0.19: 'GTG'},
        D: {0.65: 'GAT', 0.35: 'GAC'},
        E: {0.7: 'GAA', 0.3: 'GAG'},
        S: {0.26: 'TCT', 0.21: 'TCA', 0.16: 'TCC', 0.161: 'AGT', 0.11: 'AGC', 0.1: 'TCG'},
        C: {0.63: 'TGT', 0.37: 'TGC'},
        W: {1.0: 'TGG'},
    ...
    "Streptomyces": {
        F: {0.98: 'TTC', 0.02: 'TTT'},
        L: {0.6: 'CTG', 0.36: 'CTC', 0.02: 'TTG', 0.021: 'CTT', 0.0: 'TTA', 0.001: 'CTA'},
        Y: {0.95: 'TAC', 0.05: 'TAT'},
        X: {0.8: 'TGA', 0.17: 'TAG', 0.03: 'TAA'},
        H: {0.93: 'CAC', 0.07: 'CAT'},
        Q: {0.95: 'CAG', 0.05: 'CAA'},
        I: {0.96: 'ATC', 0.02: 'ATT', 0.021: 'ATA'},
        M: {1.0: 'ATG'},
        N: {0.96: 'AAC', 0.04: 'AAT'},
        K: {0.95: 'AAG', 0.05: 'AAA'},
        ...
        C: {0.91: 'TGC', 0.09: 'TGT'},
        W: {1.0: 'TGG'},
        P: {0.54: 'CCG', 0.41: 'CCC', 0.02: 'CCT', 0.021: 'CCA'},
    ...
    "Zea mays (Maize)": {
        F: {0.63: 'TTC', 0.37: 'TTT'},
        L: {0.25: 'CTC', 0.251: 'CTG', 0.18: 'CTT', 0.15: 'TTG', 0.08: 'TTA', 0.081: 'CTA'},
        Y: {0.63: 'TAC', 0.37: 'TAT'},
        ...
        C: {0.66: 'TGC', 0.34: 'TGT'},
        W: {1.0: 'TGG'},
        P: {0.26: 'CCA', 0.261: 'CCG', 0.24: 'CCT', 0.241: 'CCC'},
        ...
        G: {0.39: 'GGC', 0.21: 'GGT', 0.211: 'GGG', 0.2: 'GGA'},
    }
};