const PlasmidViewer = new class {
    ...
    drawCircular(plasmidName, sequence, complementarySequence, features, topology) {
        const mainViewerDiv = document.getElementById("linear-view-container").parentElement
        const mainViewerDivStyle = getComputedStyle(mainViewerDiv)
        const maxWidth = mainViewerDiv.offsetWidth - (parseFloat(mainViewerDivStyle.paddingLeft) + parseFloat(mainViewerDivStyle.paddingRight));
        const maxHeight = mainViewerDiv.offsetHeight - (parseFloat(mainViewerDivStyle.paddingTop) + parseFloat(mainViewerDivStyle.paddingBottom));
        ...
        for (let i in ticksPos) {
            ...
            console.log(ticksPos[i], a2, Math.floor(a2 / 180))
    ...
    drawLinear(plasmidName, sequence, complementarySequence, features, topology) {
        ...
        */
        ...
        groupFeatures.appendChild(this.linearFeature(
            [seqToPixel(1000), seqToPixel(2000)],
            featuresLevels[0],
            "fwd",
            "Hi",
            "#ff8000",
        ...
        groupFeatures.appendChild(this.linearFeature(
            [seqToPixel(1500), seqToPixel(2500)],
            featuresLevels[1],
            "fwd",
            "Hi",
            "#ff8000",
        ...
        groupFeatures.appendChild(this.linearFeature(
            [seqToPixel(3000), seqToPixel(5000)],
            featuresLevels[1],
            "rev",
            "Hi",
            "#ff8000",
        ...
        groupFeatures.appendChild(this.linearFeature(
            [seqToPixel(2500), seqToPixel(2800)],
            featuresLevels[2],
            null,
            "Hi",
            "#ff8000",
    ...
    circularFeature(span, levelHeight, directionality, label, color, id, cssClass, seqToPixel, sequenceLength) {
        ...
        console.log(seqToPixel(Math.PI, 50))
        /**
         * Arrow
         */
